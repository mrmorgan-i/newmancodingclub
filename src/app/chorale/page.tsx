...
const videos = [
  {
    id: "8kth5amlnh8w",
    title: "Heartbreaker",
    embedUrl: "https://media.cm/e/8kth5amlnh8w"
  },
  {
    id: "2wlpe9evnvm3",
    title: "You Can't Stop The Beat (Girls)",
    embedUrl: "https://media.cm/e/2wlpe9evnvm3"
  },
  {
    id: "o7jqgaooook4",
  ...
  {
    id: "llh271oop8yi",
    title: "Dancing Queen (New)",
    embedUrl: "https://media.cm/e/llh271oop8yi"
  },
  {
    id: "n983ppbfn285",
    title: "Bye Bye Bye",
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6 flex-grow">
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center">
                <p className="text-foreground-accent text-sm">Newman University Spring Show Dance</p>
                <button 
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden md:w-72">
            <div className="p-4 bg-gray-50 border-b">
              <h2 className="font-semibold">Newman Spring Show Dances Playlist</h2>
            </div>
              ...
              {videos.map((video, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-foreground-accent">Newman University Spring Show Dance</p>
                  </div>
                </button>
              ))}
            </div>
